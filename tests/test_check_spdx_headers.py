...
class TestValidateNewFile(unittest.TestCase):
    ...
    def test_new_file_missing_header(self):
        ...
        violations = []
        validate_new_file("test.py", None, False, violations)
    ...
    def test_new_file_invalid_year(self):
        ...
        violations = []
        validate_new_file("test.py", "2025", True, violations)
    ...
    def test_new_file_with_year_range(self):
        ...
        violations = []
        validate_new_file("test.py", "2023-2026", True, violations)
        self.assertEqual(len(violations), 1)
    ...
    def test_new_file_valid(self):
        ...
        violations = []
        validate_new_file("test.py", str(CURRENT_YEAR), True, violations)
...
class TestValidateModifiedFile(unittest.TestCase):
    ...
    def test_modified_file_missing_header(self):
        ...
        violations = []
        validate_modified_file("test.py", None, False, 2023, violations)
        self.assertEqual(len(violations), 1)
        self.assertIn("Missing SPDX header", violations[0].message_en)
    ...
    def test_modified_file_same_year_current(self):
        ...
        violations = []
        validate_modified_file("test.py", str(CURRENT_YEAR), True, CURRENT_YEAR, violations)
        self.assertEqual(len(violations), 0)

    def test_modified_file_older_without_range(self):
        """Test modified file from older year without range format."""
        violations = []
        validate_modified_file("test.py", "2023", True, 2023, violations)
        self.assertEqual(len(violations), 1)
    ...
    def test_modified_file_with_correct_range(self):
        ...
        violations = []
        validate_modified_file("test.py", f"2023-{CURRENT_YEAR}", True, 2023, violations)
        self.assertEqual(len(violations), 0)

    def test_modified_file_with_incorrect_range_end(self):
        """Test modified file with incorrect range end year."""
        violations = []
        validate_modified_file("test.py", "2023-2025", True, 2023, violations)
        self.assertEqual(len(violations), 1)
    ...
    def test_modified_file_identical_range(self):
        ...
        violations = []
        validate_modified_file("test.py", f"{CURRENT_YEAR}-{CURRENT_YEAR}", True, CURRENT_YEAR, violations)
        self.assertEqual(len(violations), 1)
